...
namespace Canis
{
    void Blocks::BlocksInit(std::vector<std::vector<std::vector<unsigned int>>> _map, Canis::World world)
    {
        ...
        Canis::Model fireModel = Canis::LoadModel("assets/models/fire_model.obj");
